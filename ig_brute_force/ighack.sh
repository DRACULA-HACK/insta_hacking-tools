...
#####3#3#
check(){
if wget --spider https://raw.githubusercontent.com/noob-hackers/ig_brute_force/master/u>
...
option
check1(){
if wget --spider https://raw.githubusercontent.com/noob-hackers/patchupdateznh/main/ig_>
cd ig_brute_force/core
echo "igg" > patch.txt
else
echo
...
printf "\n"
printf "       \e[100m\e[1;77m >>  Youtube Channel : \e[1;96m Noob Hackers \e[100m\e[1;>
printf "\n"
}
baner1(){
clear
...
more(){
  clear
center() {                                                                             >
  printf '%*.*s %s %*.*s\n' 0 "$(((termwidth-2-${#1})/2))" "$padding" "$1" 0 "$(((termw>
}
echo -e '\e[92m
...
if [ "$optz" = "1" ];
then
am start -a android.intent.action.VIEW -d https://noob-hackers.github.io/noobspage 2>/d>
more
clear
elif [ "$optz" = "2" ];
then
...
echo -e "\e[96m                ║                                   ║\e[0m"
echo -e "\e[96m                ║        Select \e[92my\e[96m to watch\e[96m          ║\>
echo -e "\e[96m                ║                (\e[93mOR\e[96m)               \e[96m║\>
echo -e "\e[96m                ║        Select \e[91mt\e[96m to cancel\e[96m         ║\>
echo -e "\e[96m                ║                (\e[93mOR\e[96m)               \e[96m║\>
echo -e "\e[96m                ║     Select \e[91mz\e[96m to skipforever\e[96m       ║\>
echo -e "\e[96m                ╚═══════════════════════════════════╝\e[0m"
