...
figlet -f Bloody Insta-Hack | lolcat
    ...
    echo -e "$Red                               ⫸$Purple Incredible Hackers$Red ⫷\033[0>
echo " "
echo -e " $Green     |----------------------------------------------------------------->
echo -e " $Green     ||----------------------------$Cyan [features] $Green------------->
echo -e " $Green     ||                                                                >
echo -e " $Green     ||             $Purple==>$Yellow[1️⃣] Insta information gathering$Gr>
echo -e " $Green     ||             $Purple==>️$Yellow[2️⃣] Insta brute force attack$Green>
echo -e " $Green     ||             $Purple==>$Yellow[3️⃣] Insta auto reporter$Green     >
echo -e " $Green     ||             $Purple==>$Yellow[4️⃣] Insta phishing page(coming soo>
