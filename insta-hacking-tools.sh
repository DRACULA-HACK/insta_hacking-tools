...
echo -e "$Purple Created By \e[1;34m"
       figlet figlet Incredible Hacker | lolcat
sleep 2.0
    echo -e " \e[96m
                                     ████████ \e[0m"
echo "                                 ████████████████
...
echo -e    "\e[91m"
echo " "
figlet -f Bloody Insta_Hacking-tool| lolcat

    echo " "
    echo -e "$Red                                 ⫸ Coded by$Yellow Incredible Hackers$Red ⫷\033[0m"
    echo -e "$Red                               ⫸$Purple MASTER-HACK$Red ⫷\033[0m"
echo " "
echo -e " $Green     |---------------------------------------------------------------------|"
